...
Если вы внесли изменения в репозиторий на GitHub, просто перезапустите команду установки на устройстве. mip скачает обновленные файлы и перезапишет старые версии.
Python
