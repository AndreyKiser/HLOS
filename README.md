...
При запуске программы выберите свою версию ESP32 ![1](https://github.com/user-attachments/assets/517d119b-a5cd-44df-a1c1-8edf60c0e8ec)
 ...
 ![2](https://github.com/user-attachments/assets/d48b8ab7-b000-4bfb-bf1d-2b6d90976dfb)
  1. Выберите файл прошивки для своей платы   2. Адрес для прошивки ESP32 – 0x0000, для ESP32-C3 0x0   3.Выбрать порт к которому подключена ESP32   4. Выбрать скорость загрузки
  5. Очистить flash память   6. Запустить прошивку ESP32, по окончании прошивки появится надпись Finish  
